...
def compute_about(*args, **kwargs):
    ...
    st.write(
        "DISCLAIMER:  This is a project by TheDisasterFish and friends.  All work is best effort and strictly voluntary.  Inclusion in the results isn't guaranteed and we make no warranties as to the site accuracy."
    )
